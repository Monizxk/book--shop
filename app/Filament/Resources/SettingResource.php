...
////                        return match($state) {
////                            'delivery_cost' => 'Delivery Cost',
////                            'working_hours.weekdays.label' => 'Weekdays Label',
////                            'working_hours.weekdays.hours' => 'Weekdays Hours',
////                            'working_hours.weekdays.enabled' => 'Weekdays Enabled',
////                            'working_hours.saturday.label' => 'Saturday Label',
////                            'working_hours.saturday.hours' => 'Saturday Hours',
////                            'working_hours.saturday.enabled' => 'Saturday Enabled',
////                            'working_hours.sunday.label' => 'Sunday Label',
////                            'working_hours.sunday.hours' => 'Sunday Hours',
////                            'working_hours.sunday.enabled' => 'Sunday Enabled',
////                            'contact_phone' => 'Contact Phone',
////                            'contact_viber' => 'Contact Viber',
////                            'contact_email' => 'Contact Email',
////                            'delivery_title' => 'Delivery Page Title',
...
////                    })
//                    ->badge()
//                    ->color(fn (string $state): string => str_contains($state, 'working_hours') ? 'info' : 'primary'),
//
//                Tables\Columns\TextColumn::make('value')
//                    ->label('Value')
//                    ->formatStateUsing(function (string $state, $record): string {
//                        return match($record->key) {
//                            'delivery_cost' => $state . ' UAH',
//                            'working_hours.weekdays.enabled',
//                            'working_hours.saturday.enabled',
//                            'working_hours.sunday.enabled' => $state === '1' ? 'Enabled' : 'Disabled',
//                            'contact_phone',
//                            'contact_viber',
//                            'contact_email' => $state,
//                            'delivery_title',
...
//                            'payment_np_cod_note',
//                            'payment_np_cod_important',
//                            'payment_np_cod_important2' => $state,
//                            default => $state,
//                        };
//                    })
//                    ->badge()
//                    ->color(function (string $state, $record): string {
//                        if (in_array($record->key, ['working_hours.weekdays.enabled', 'working_hours.saturday.enabled', 'working_hours.sunday.enabled'])) {
...
//                        return $query->when(
//                            $data['value'] === 'delivery',
//                            fn (Builder $query): Builder => $query->where('key', 'delivery_cost'),
//                        )->when(
//                            $data['value'] === 'working_hours',
//                            fn (Builder $query): Builder => $query->where('key', 'like', 'working_hours.%'),
//                        )->when(
//                            $data['value'] === 'other',
//                            fn (Builder $query): Builder => $query->where('key', '!=', 'delivery_cost')
//                                ->where('key', 'not like', 'working_hours.%'),
//                        );
//                    }),
//            ])
//            ->actions([
